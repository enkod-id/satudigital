...
import { withAuthentication } from '@/utils/authMiddleware';
...
const AccountSetting = () => {
    ...
    const initialFormData = {
      ...
      const isFormDataValid = () => {
        // Exclude the checkbox from validation
        const { makeDefaultAddress, ...fields } = formData;
      ...
      const handleSubmit = async () => {
        ...
        try {
          const response = await fetch('http://localhost:5000/v1/profiles', {
            method: 'POST',
            headers: {
      ...
      const handleResponse = async (response) => {
        switch (response.status) {
          ...
          case 403:
            ...
            break;
          default:
            console.error('Failed to create profile with status:', response.status);
        }
      };
                ...
                {tabs === 'home' ? (
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row">
                            {/* Bagian gambar profil - tidak memerlukan input */}
                            <div className="mb-5 w-full sm:w-2/12 ltr:sm:mr-4 rtl:sm:ml-4">
                            <img src="/assets/images/profile-34.jpeg" alt="Profile" className="mx-auto h-20 w-20 rounded-full object-cover md:h-32 md:w-32" />
                            </div>
                            ...
                            <div>
                                ...
                                name="nameStore"
                                type="text"
                                placeholder="Jakarta store Turner"
...
export default withAuthentication(AccountSetting);
