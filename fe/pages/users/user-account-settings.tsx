...
const AccountSetting = () => {
    ...
    const idUser = 'user-id-from-session'; // Ganti dengan logika sesi pengguna yang sebenarnya
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await response.json(); // Selalu baca badan respons
    
            if (response.ok) {
                console.log('Profile created successfully', data);
            } else {
                console.error('Failed to create profile:', data.message || 'Unknown error');
            }
        } catch (error) {
