                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            ...
                            <div class="relative text-white-dark">
                                <input id="Email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" v-model="email" />
                                <!-- ... icon mail ... -->
                            </div>
                            </div>
                            <div>
                            ...
                            <div class="relative text-white-dark">
                                <input id="Password" type="password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark" v-model="password" />
                                <!-- ... icon lock ... -->
                            </div>
                            </div>
                            <!-- ... elemen lainnya (checkbox, dll.) ... -->
...
<script lang="ts" setup>
  ...
  import { useAppStore } from '@/stores/index'; // Pastikan ini mengarah ke store Pinia Anda
  import { useRouter } from 'vue-router';
  import { useI18n } from 'vue-i18n';

  // Gunakan useAppStore dari Pinia, bukan useStore dari Vuex
  ...
  const login = async () => {
      try {
          ...
          store.setToken(data.token); // Panggil mutation setToken langsung sebagai method
          router.push('/dashboard'); // Redirect pengguna ke halaman dashboard
      } catch (error) {
