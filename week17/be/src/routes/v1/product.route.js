 ...
 *     description: Logged in users can only update their own information. Only admins can update other products.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can delete only themselves. Only admins can delete other products.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
